...
def seed_users():
  demo = User(username='demoWord', email='demo@email.com', password='password', lastLoggedIn=datetime.now())
  ...
  seedUser8 = User(username='madbrad420', email='brad@gmail.com', password='password', lastLoggedIn=datetime.now())
